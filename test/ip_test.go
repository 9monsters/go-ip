...
func TestIsIpV4(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := goip.IsIpV4(tt.args.ip); got != tt.want {
...
func TestIsIpV6(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := goip.IsIpV6(tt.args.ip); got != tt.want {
...
func TestListAllIp(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := goip.ListAllIp(tt.args.predicate, tt.args.ifaceNames...)
...
func TestListAllIpV4(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := goip.ListAllIpV4(tt.args.ifaceNames...)
			if (err != nil) != tt.wantErr {
...
func TestListAllIpV6(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := goip.ListAllIpV6(tt.args.ifaceNames...)
			if (err != nil) != tt.wantErr {
...
func TestOutbound(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := goip.Outbound(); got != tt.want {
...
func TestMainIP(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, got1 := goip.MainIP(tt.args.ifaceName...)
			if got != tt.want {
